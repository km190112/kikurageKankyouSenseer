/**************************************
  ...
  サーバーにデータを送信後すぐにDeep Sllepモードに移行し、900sごとに再度測定をする、
 **************************************/
...
// //ルーター設定
#define WIFISSID "yure SSID"                                                      // ルーターのSSID
#define WIFIPASS "XxXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"  //PSK ハッシュ値256bitのキー(https://mascii.github.io/wpa-psk-calc/

//Ambient
Ambient ambient;
uint32_t channelId = 0000001;                 // AmbientのチャネルID
